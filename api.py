...
# if you try to login, prompt the login screen and only continue if they log in successfully
...
# if you try to logout, set the email and user id to none
...
# adding an address into the database
...
# adding a ticket to the database for help
...
# download a file from the ticket screen
@api.route("/download/<path:filename>")
def download(filename):
    return send_file(os.path.join(UPLOAD_FOLDER, filename), as_attachment=True)

# search for certain orders
